...
export const communityQueryKeys = {
  ...
  userFollowing: (userId: number, query: PageQuery = {}) =>
    [...communityQueryKeys.follows(), 'user-following', userId, query] as const,
  userFollowers: (userId: number, query: PageQuery = {}) =>
    [...communityQueryKeys.follows(), 'user-followers', userId, query] as const,
  ...
  publicActivities: (query: CommunityActivityListQuery = {}) =>
    [...communityQueryKeys.activities(), 'public', query] as const,
  myActivities: (query: CommunityActivityListQuery = {}) =>
    [...communityQueryKeys.activities(), 'mine', query] as const,
  ...
  userActivities: (userId: number, query: CommunityActivityListQuery = {}) =>
    [...communityQueryKeys.activities(), 'user', userId, query] as const,
  ...
  notificationList: (query: CommunityNotificationListQuery = {}) =>
    [...communityQueryKeys.notifications(), 'list', query] as const,
...
export const communityMutations = {
  ...
  updatePost: () =>
    mutationOptions({
      mutationFn: ({ postId, body }: { postId: number; body: Partial<CommunityPostBody> }) =>
  ...
  createComment: () =>
    mutationOptions({
      mutationFn: (body: CommunityCommentBody & { target_type: CommunityTargetType; target_id: number }) =>
        communityCommentsApi.create(body),
    }),
  updateComment: () =>
    mutationOptions({
      mutationFn: ({
        ...
        commentId: number;
        body: Partial<Pick<CommunityCommentBody, 'content' | 'visibility' | 'is_spoiler'>>;
      }) => communityCommentsApi.update(commentId, body),
    }),
  ...
  react: () =>
    mutationOptions({
      ...
      }) => communityInteractionsApi.react(body),
    }),
  unreact: () =>
    mutationOptions({
      mutationFn: (body: {
  ...
  bookmark: () =>
    mutationOptions({
      mutationFn: (body: { target_type: CommunityTargetType; target_id: number }) =>
        communityInteractionsApi.bookmark(body),
    }),
  unbookmark: () =>
    mutationOptions({
      mutationFn: (body: { target_type: CommunityTargetType; target_id: number }) =>
  ...
  createReport: () =>
    mutationOptions({
      mutationFn: (body: {
        ...
        description?: string;
      }) => communityReportsApi.create(body),
    }),
  resolveReport: () =>
    mutationOptions({
      mutationFn: ({
      ...
      }) => communityReportsApi.resolve(reportId, body),
    }),
};
