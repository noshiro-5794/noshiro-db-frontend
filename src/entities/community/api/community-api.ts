import { api, apiRequest } from '@/shared/api';
...
export const communityFollowsApi = {
  follow: (targetUserId: number) =>
    api.post<FollowRelation>(`/api/community/me/following/${encodePath(targetUserId)}/`),
  unfollow: (targetUserId: number) => api.delete<unknown>(`/api/community/me/following/${encodePath(targetUserId)}/`),
  listMyFollowing: (query: PageQuery = {}) =>
    api.get<ApiPage<FollowRelation>>('/api/community/me/following/', { query }),
  listMyFollowers: (query: PageQuery = {}) =>
    api.get<ApiPage<FollowRelation>>('/api/community/me/followers/', { query }),
...
export const communityRelationshipsApi = {
  listBlocks: (query: PageQuery = {}) =>
    api.get<ApiPage<CommunityRelationship>>('/api/community/me/blocks/', { query }),
...
export const communityActivitiesApi = {
  listPublic: (query: CommunityActivityListQuery = {}) =>
    api.get<ApiPage<Activity>>('/api/community/activities/', { query }),
  listMine: (query: CommunityActivityListQuery = {}) =>
    api.get<ApiPage<Activity>>('/api/community/me/activities/', { query }),
  listFeed: (query: CommunityActivityListQuery = {}) =>
    api.get<ApiPage<Activity>>('/api/community/me/feed/', { query }),
...
export const communityPostsApi = {
  list: (query: CommunityPostListQuery = {}) =>
    api.get<ApiPage<CommunityPostSummary>>('/api/community/posts/', { query }),
...
export const communityCommentsApi = {
  list: (query: CommunityCommentListQuery) =>
    api.get<ApiPage<CommunityCommentSummary>>('/api/community/comments/', { query }),
...
export const communityInteractionsApi = {
  ...
  listBookmarks: (query: CommunityBookmarkListQuery = {}) =>
    api.get<ApiPage<CommunityBookmark>>('/api/community/bookmarks/', { query }),
...
export const communityNotificationsApi = {
  list: (query: CommunityNotificationListQuery = {}) =>
    api.get<ApiPage<CommunityNotification>>('/api/community/notifications/', { query }),
  unreadCount: () => api.get<CommunityNotificationUnreadCount>('/api/community/notifications/unread-count/'),
  markRead: (notificationId: number) =>
    api.patch<CommunityNotification>(`/api/community/notifications/${encodePath(notificationId)}/read/`),
...
export const communityReportsApi = {
  ...
  listMine: (query: CommunityReportListQuery = {}) =>
    api.get<ApiPage<CommunityReport>>('/api/community/me/reports/', { query }),
  listStaff: (query: CommunityReportListQuery = {}) =>
    api.get<ApiPage<CommunityReport>>('/api/community/staff/reports/', { query }),
  resolve: (
    reportId: number,
