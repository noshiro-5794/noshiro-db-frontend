...
import { indexApi, type SubjectEpisodeQuery, type SubjectListQuery, type SubjectStaffQuery } from '@/features/subjects/api';
...
export const subjectQueryKeys = {
  ...
  episodes: (subjectId: UUID, query?: object) => [...subjectQueryKeys.detail(subjectId), 'episodes', query ?? 'default'] as const,
  episode: (subjectId: UUID, episodeId: number) => [...subjectQueryKeys.detail(subjectId), 'episodes', episodeId] as const,
  staff: (subjectId: UUID, query?: SubjectStaffQuery) => [...subjectQueryKeys.detail(subjectId), 'staff', query ?? 'default'] as const,
  staffRoles: (subjectId: UUID) => [...subjectQueryKeys.detail(subjectId), 'staff', 'roles'] as const,
  characters: (subjectId: UUID, query?: object) => [...subjectQueryKeys.detail(subjectId), 'characters', query ?? 'default'] as const,
  relations: (subjectId: UUID, query?: object) => [...subjectQueryKeys.detail(subjectId), 'relations', query ?? 'default'] as const,
