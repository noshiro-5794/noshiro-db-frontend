...
export const api = {
  ...
  post: <TData, TBody = unknown>(path: string, body?: TBody, options?: Omit<ApiRequestOptions<TBody>, 'method' | 'body'>) =>
    apiRequest<TData, TBody>(path, { ...options, method: 'POST', body }),

  put: <TData, TBody = unknown>(path: string, body?: TBody, options?: Omit<ApiRequestOptions<TBody>, 'method' | 'body'>) =>
