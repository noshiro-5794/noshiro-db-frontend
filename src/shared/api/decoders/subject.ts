...
export function decodeCalendarBoardEntries(value: unknown): CalendarBoardEntry[] {
  ...
  return value.map((item) => {
    ...
    return {
      ...
      windowStart: isString(item['window_start']) ? item['window_start'] : '',
      windowEnd: isString(item['window_end']) ? item['window_end'] : '',
      workId: item['work_id'],
      ...
      premieredOn: isNullableString(item['premiered_on']) ? item['premiered_on'] : null,
      endedOn: isNullableString(item['ended_on']) ? item['ended_on'] : null,
      episodeCount: isInteger(item['episode_count']) ? item['episode_count'] : null,
